...
require (
	...
	github.com/looplj/axonhub/llm v0.0.0-20260813091334-fc1d27dad411
...
// axonhub/llm 依赖的 SSE fork（其 httpclient 使用 fork 新增的 StreamConfig/Stream API）。
// replace 仅在主 module 的 go.mod 生效，传递依赖的 replace 不会继承，故需在此显式声明。
