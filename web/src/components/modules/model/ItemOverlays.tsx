...
type ChannelModelEditOverlayProps = {
    layoutId: string;
    modelName: string;
    brandColor: string;
    editValues: EditValues;
...
export function ChannelModelEditOverlay({
    layoutId,
    modelName,
    brandColor,
    editValues,
...
type ChannelModelDeleteOverlayProps = {
    layoutId: string;
    isPending: boolean;
    onCancel: () => void;
    onConfirm: () => void;
...
export function ChannelModelDeleteOverlay({
    layoutId,
    isPending,
    onCancel,
    onConfirm,
}: ChannelModelDeleteOverlayProps) {
    const t = useTranslations('model.overlay');
    return (
        <motion.div
            layoutId={layoutId}
        ...
        >
            ...
            >
                ...
                {isPending ? t('deleting') : t('confirmRestore')}
            </button>
        </motion.div>
    );
}