import { ChannelType, type AutoGroupType, type Channel, type ChannelGroup, type ChannelTestResult, type ChannelWSMode, type ModelRedirect, useFetchModel, useTestChannel } from '@/api/endpoints/channel';
    ...
    const handleAddChannelGroup = () => {
        onFormDataChange({
            ...
            channel_groups: [
                ...
                { alias: '', mode: GroupMode.Weighted, items: [] },
            ],
        });
    };
    ...
    return (
        <form onSubmit={onSubmit} className="space-y-4 px-1">
            ...
            <div className="space-y-2">
                ...
                <ChannelGroupEditor
                    groups={formData.channel_groups ?? []}
                    modelCandidates={modelCandidates}
                    onChange={(groups) => onFormDataChange({ ...formData, channel_groups: groups })}
                />
            </div>
