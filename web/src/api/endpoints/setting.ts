...
export const SettingKey = {
    ...
    QualityFailEnabled: 'relay_quality_fail_enabled',
    QualityFailMinOutput: 'relay_quality_fail_min_output',
    QualityFailMinMaxTokens: 'relay_quality_fail_min_max_tokens',
    QualityFailCooldown: 'relay_quality_fail_cooldown',
    ...
    AutoRankEnabled: 'auto_rank_enabled',
    AutoRankInterval: 'auto_rank_interval',
    AutoRankExploreRatio: 'auto_rank_explore_ratio',
    AutoRankMinSamples: 'auto_rank_min_samples',
    AutoRankChannelFactorEnabled: 'auto_rank_channel_factor_enabled',
    AutoRankChannelMinSamples: 'auto_rank_channel_min_samples',
    AutoRankChannelMinModels: 'auto_rank_channel_min_models',
    AutoRankChannelDegradeRate: 'auto_rank_channel_degrade_rate',
    AutoRankTTFBEnabled: 'auto_rank_ttfb_enabled',
    AutoRankTTFBWeight: 'auto_rank_ttfb_weight',
    AutoRankTTFBMaxSlowRatio: 'auto_rank_ttfb_max_slow_ratio',
    AutoRankTTFBMinConfidentSample: 'auto_rank_ttfb_min_confident_sample',
    AutoRankSuccessGap: 'auto_rank_success_gap',
    AutoRankLatencyRatio: 'auto_rank_latency_ratio',
    AutoRankHealthThreshold: 'auto_rank_health_threshold',
    AutoRankChannelMaxShare: 'auto_rank_channel_max_share',
    AutoRankModelMaxShare: 'auto_rank_model_max_share',
    AutoRankSoftmaxTemp: 'auto_rank_softmax_temp',
    AutoRankFeedbackEnabled: 'auto_rank_feedback_enabled',
    AutoRankFeedbackEwma: 'auto_rank_feedback_ewma',
    AutoRankFeedbackTolerance: 'auto_rank_feedback_tolerance',
    AutoRankFeedbackPenalty: 'auto_rank_feedback_penalty',
    AutoRankProbeEnabled: 'auto_rank_probe_enabled',
    AutoRankProbeInterval: 'auto_rank_probe_interval',
    AutoRankProbeMaxPerRound: 'auto_rank_probe_max_per_round',
    AutoRankProbeCooldown: 'auto_rank_probe_cooldown',
